...
public class Id3 {
    ...
    public static void main(String[] args) {
        menu();
        ID3_calculation id3_calculation = new ID3_calculation(table);
        id3_calculation.calculate_class();
        id3_calculation.calculate_attribute();
        id3_calculation.calculate_entropy();
        id3_calculation.information_gain();
        //
        List<Node> node = id3_calculation.getNode();
        HashMap<String,Double > information_gain = id3_calculation.getInformationGain();
        HashMap<String,String > information_gain_subAttribute = id3_calculation.getInformationGain_of_subAttribute();
        //
        Vector attributes = id3_calculation.getlistofAttributes();
    ...
    public static void readCSV(String filename){
        ...
        try {
            pre_count = new BufferedReader(new FileReader(filename));
            ...
            while ((line = br.readLine()) != null) {
                String[] attributes = line.split(cvsSplitBy);
                System.arraycopy(attributes, 1, table[rows], 0, col + 1 - 1);
                rows++;
            }
        }
        catch (IOException e) {
